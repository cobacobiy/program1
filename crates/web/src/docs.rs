...
use program1_contracts::{
    ...
    CreateUserAccountRequest, CreateVariantRequest, ErrorCode, InventoryStockDto, JwtClaims, LoginRequest,
...
#[openapi(
    paths(
        ...
        handlers::list_variants_handler,
        handlers::get_variant_handler,
        handlers::create_variant_handler,
        handlers::update_variant_handler,
        handlers::delete_variant_handler,
        ...
        handlers::get_buyer_order_handler,
