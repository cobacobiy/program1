...
use program1_contracts::{
    ...
    ChatMessageDto, ChatRoomDto, ChatSenderType, CouponDto, CouponValidationResult,
    CategoryDto, CreateCategoryRequest, UpdateCategoryRequest,
    CreateCatalogItemRequest, CreateCouponRequest, CreatePaymentRequest, CreateReviewRequest,
    CreateUserAccountRequest, CreateVariantRequest, DiscountType, ErrorCode, InventoryStockDto,
    JwtClaims, LoginRequest, LowStockAlertDto, MarketplaceOrderReq, OmniOrderDto, OrderItemDto,
    OrderStatus, PaginationParams, PaymentConfigDto, PaymentTransactionDto,
    ProductRatingSummaryDto, ProductReviewDto, ProductVariantDto, PublicReviewDto,
    RegisterBuyerRequest, RegisterUserRequest, SafetyStockLogDto, SalesAnalyticsDto,
    SendMessageRequest, StockAdjustmentLogDto, StorefrontOrderItemRequest, StorefrontOrderRequest,
    UpdateBuyerProfileRequest, UpdateBuyerStatusRequest, UpdateOrderStatusRequest,
...
#[openapi(
    paths(
        ...
        handlers::get_product_reviews_handler,
        handlers::get_product_rating_handler,
        handlers::list_buyer_reviews_handler,
        handlers::admin_list_reviews_handler,
        handlers::admin_moderate_review_handler,
        handlers::get_wishlist_handler,
        ...
        handlers::list_categories_handler,
        handlers::get_category_handler,
        handlers::create_category_handler,
        handlers::update_category_handler,
        handlers::delete_category_handler,
    ),
    components(
        schemas(
            ApiError,
    ...
    tags(
        ...
        (name = "Reviews", description = "Product review and rating management"),
        (name = "Buyer Wishlist", description = "Buyer personal wishlist and favorites"),
    ),
