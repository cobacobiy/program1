<script lang="ts">
  ...
  import type { Product, ProductVariant, CreateVariantPayload, Coupon, CreateCouponPayload, DiscountType, ProductReview, PaginatedReviews, SalesReportResponse } from './types';
  ...
  // Active sub-tab
  let subTab = $state<'kpi' | 'reports' | 'catalog' | 'inventory' | 'orders' | 'audit' | 'coupons' | 'reviews'>('kpi');
